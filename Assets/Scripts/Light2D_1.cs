...
[ExecuteInEditMode]
public class Light2D_1 : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            Vector2 direction = reverseDiretion ? new Vector2(Mathf.Cos(Mathf.Deg2Rad * i), Mathf.Sin(Mathf.Deg2Rad * i)) : new Vector2(Mathf.Sin(Mathf.Deg2Rad * i), Mathf.Cos(Mathf.Deg2Rad * i));
