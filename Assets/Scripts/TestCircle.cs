...
public class TestCircle : MonoBehaviour
{
    ...
    private class circleMeshCreator
    {
        ...
        public Mesh Create(float radius,int segments,float innerRadius,float angleDegree)
        {
            Mesh mesh = new Mesh();
        ...
        {
            return segments != this._segments || (int)((angleDegree - this._angleDegree) * PRECISION) != 0 || (int)((radius - this._radius) * PRECISION) != 0 || (int)((innerRadius - this._innerRadius) * PRECISION) != 0;
        }
